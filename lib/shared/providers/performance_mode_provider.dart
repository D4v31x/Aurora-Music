...
import 'package:aurora_music_v01/shared/services/device_performance_service.dart';
...
class PerformanceModeProvider extends ChangeNotifier {
  ...
  AnimationSettings get animationSettings {
    _currentSettings ??=
        DevicePerformanceService.instance.getAnimationSettings(_currentMode);
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      if (_autoDetect) {
        ...
        _currentMode =
            await DevicePerformanceService.instance.getPerformanceLevel();
      } else {
        // Load manual setting
  ...
  Future<void> setPerformanceMode(PerformanceLevel mode,
  ...
  bool get shouldEnableComplexAnimations =>
  ...
  String get currentModeDisplayName =>
      getPerformanceModeDisplayName(_currentMode);
