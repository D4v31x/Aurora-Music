              ...
              builder: (context, audioService, _) =>
                ...
                SettingsTiles.buildSwitchTile(
                  ...
                  icon: iconoir.Shuffle(
                      ...
                      width: 20,
                      height: 20),
                  title: l10n.settingsAutomix,
                  subtitle: l10n.settingsAutomixDesc,
                  value: audioService.automixEnabled,
                  onChanged: (v) => audioService.setAutomixEnabled(v),
                ),
                // Manual crossfade controls are superseded by Automix while
                // it's on, so they're hidden rather than shown disabled.
                if (!audioService.automixEnabled) ...[
                  SettingsTiles.buildSwitchTile(
                    context,
